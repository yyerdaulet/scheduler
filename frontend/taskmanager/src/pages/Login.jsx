...
styleTag.textContent = `
  ...
  .ln-input::placeholder { color: #d4c98a; }
  ...
  .ln-submit:hover { background: var(--accent); transform: translateY(-1px); }
  .ln-submit:disabled { opacity: 0.5; cursor: not-allowed; transform: none; }
